...
namespace pryEdAstudillog
{
    public partial class frmEstructuraDatos : Form
    {
        ...
        {
            frmMeses v = new frmMeses(); v.ShowDialog();
        }
        ...
        {
            frmColores v = new frmColores(); v.ShowDialog();
        }
        ...
        {
            frmPila v = new frmPila(); v.ShowDialog();
        }

        private void listaSimpleToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmListaSimple v= new frmListaSimple(); v.ShowDialog();
        }
